...
- `context/admin/dashboard.md` — Protected admin dashboard navigation, operations summary, and reservation list/search query boundaries.
...
- `app/admin/(dashboard)/` — Authenticated admin route group protected by the admin layout; includes summary, reservation list/search, pricing, availability, calendar, and reports route boundaries.
...
- `lib/admin-dashboard/` — Server-only admin dashboard summary and reservation list/search query helpers.
