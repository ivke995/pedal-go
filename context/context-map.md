...
- `context/admin/dashboard.md` — Protected admin dashboard navigation, operations summary, reservation list/search, and manual reservation creation boundaries.
...
- `app/admin/(dashboard)/` — Authenticated admin route group protected by the admin layout; includes summary, reservation list/search/manual creation, pricing, availability, calendar, and reports route boundaries.
...
- `lib/admin-dashboard/` — Server-side admin dashboard summary, reservation list/search, and manual reservation creation helpers.
...
- `tests/admin-dashboard/` — Unit tests for admin dashboard server-side orchestration, including manual reservations.
