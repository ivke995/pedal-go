...
- `context/admin/dashboard.md` — Protected admin dashboard navigation, route boundaries, and operations summary query boundary.
...
- `app/admin/(dashboard)/` — Authenticated admin route group protected by the admin layout; includes summary, reservations, pricing, availability, calendar, and reports route boundaries.
...
- `lib/admin-dashboard/` — Server-only admin dashboard summary query helpers.
