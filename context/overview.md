...
- Administrators sign in through `/admin/login`; authenticated active admins can reach the protected `/admin` dashboard shell, navigate summary/reservations/pricing/availability/calendar/reports sections, see database-backed operations summary metrics, and log out.
...
- `lib/admin-dashboard/` contains server-only admin operations summary queries for the protected dashboard.
