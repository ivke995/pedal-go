...
- `lib/admin-dashboard/` contains server-side admin operations summary, reservation listing, manual reservation creation, reservation cancellation, and pricing management helpers for the protected dashboard.
