...
- Cover server-side domain behavior with Node test-runner tests under `tests/domain/`; cover public booking orchestration under `tests/public-booking/`; run them with `pnpm test`.
